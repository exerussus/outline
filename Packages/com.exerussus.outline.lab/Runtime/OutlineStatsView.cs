    ...
    public partial class OutlineStatsView : VisualElement
    {
        ...
        public OutlineStatsView()
        {
            ...
            _help.text =
                ...
                "0..3 — отладка (кадр / маска / сиды / поле) · P — паттерн выделения · O — его пространство · C — кроп · A — сглаживание · V — вид на эффекты · T — плавная смена стиля выделенных · панель UI: ЛКМ стиль, ПКМ растворить, колесо пульс\nпод курсором: X — растворить/проявить · G — пульс · F — вспышка";
            Add(_stats);
            Add(_help);
        }
